var TaskView = function (model) {
    ...
    this.reopenTaskEvent = new Event(this);
...
TaskView.prototype = {
    ...
    setupHandlers: function () {
        ...
        this.reopenTaskButtonHandler = this.reopenTaskButton.bind(this);
        ...
        */
        ...
        this.reopenTasksHandler = this.reopenTasks.bind(this);
    ...
    enable: function () {
        ...
        this.$container.on('click', '.js-reopen-task-button', this.reopenTaskButtonHandler);
        ...
        this.model.reopenTasksEvent.attach(this.reopenTasksHandler);
    ...
    reopenTaskButton: function () {
        this.reopenTaskEvent.notify();
    },    
    ...
    buildList: function () {
        ...
        for (var task in tasks) {
            ...
            } else if (tasks[task].taskStatus == 'reopened') {
